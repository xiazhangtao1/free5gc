...
func NewServer(pcf pcf, tlsKeyLogPath string) (*Server, error) {
	...
	xcnDedicatedBearerRoutes := s.getXcnDedicatedBearerRoutes()
	xcnDedicatedBearerGroup := s.router.Group("/xcn-dedicated-bearer/v1")
	applyRoutes(xcnDedicatedBearerGroup, xcnDedicatedBearerRoutes)
